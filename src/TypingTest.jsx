  ...
  render() {
    return (
      <div className="TypingTest">
        <br />
        <div style={divStyle}>
          <input autoComplete="off" hidden={this.state.hideTextSubmission} id="typingField" className={this.state.classOfText} onPaste={(e) => { e.preventDefault(); return false; }} type="text" name="typing"
